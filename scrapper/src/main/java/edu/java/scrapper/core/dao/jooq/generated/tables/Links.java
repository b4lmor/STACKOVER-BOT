...
public class Links extends TableImpl<LinksRecord> {
    ...
    /**
     * The column <code>LINKS.LVALUE</code>.
     */
    public final TableField<LinksRecord, String> LVALUE =
        createField(DSL.name("LVALUE"), SQLDataType.VARCHAR(400).nullable(false), this, "");
